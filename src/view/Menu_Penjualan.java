...
public class Menu_Penjualan extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tbl_detail.setBackground(new java.awt.Color(255, 255, 255));
        tbl_detail.setForeground(new java.awt.Color(0, 0, 0));
        ...
        tbl_sementara.setBackground(new java.awt.Color(255, 255, 255));
        tbl_sementara.setForeground(new java.awt.Color(0, 0, 0));
...
//        txt_namajenisbarang.setText(tbl_barang.getModel().getValueAt(row, 2).toString());
    ...
    private void tampilPanel() {
       mainPanel.removeAll();
       mainPanel.add(new Menu_Penjualan());
       mainPanel.repaint();
       mainPanel.revalidate();
    }
