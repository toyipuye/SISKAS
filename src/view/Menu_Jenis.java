 ...
 * @author UsEr
 */
public class Menu_Jenis extends javax.swing.JPanel {
        ...
        if(index!=-1){
            ...
            {   
                    if(validasiInput()== true){
                        ...
                        String idkategori = txt_kodejenisbarang.getText();
                        String namakategori = txt_namajenisbarang.getText();

                        Model_Jenis_Barang jbr = new Model_Jenis_Barang();

                        jbr.setId_kategori(idkategori);               
                        jbr.setNama_kategori(namakategori);
